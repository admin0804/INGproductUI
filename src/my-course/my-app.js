...
class MyApp extends PolymerElement {
      ...
      <app-drawer-layout fullbleed="" narrow="{{narrow}}">
        ...
        <app-drawer id="drawer" slot="drawer" swipe-open="[[narrow]]">
          ...
          <iron-selector selected="[[page]]" attr-for-selected="name" class="drawer-list" role="navigation">
            ...
            <a name="productslist" href="#/productslist">Products List</a>
            <a name="productdetails" href="#/productdetails">Product Details</a>
          </iron-selector>
        </app-drawer>
  ...
  _routePageChanged(page) {
    ...
    if (!page) {
      this.page = 'productslist';
    } else if (['productslist','productdetails'].indexOf(page) !== -1) {
      this.page = page;
    } else {
      this.page = 'view404';
    }
